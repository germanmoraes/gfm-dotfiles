...
Item {
    ...
    readonly property int iconFontSize:
        18

    // ============================================================
    // GEOMETRIA DOS ÍCONES
    // ============================================================

    // Área comum ocupada por cada ícone dentro da cápsula.
    readonly property int iconSlotSize:
        20

    // Ajuste vertical comum para todos os ícones.
    // 0 = centralização padrão.
    readonly property int iconVerticalOffset:
        0
    ...
    readonly property color ethernetColor:
        "#00ffff"
    ...
    readonly property color brightnessColor:
        "#ffff00"
    ...
    readonly property string volumeIconHigh:
        String.fromCodePoint(0xE050)

    readonly property string volumeIconMedium:
        String.fromCodePoint(0xE04D)

    readonly property string volumeIconZero:
        String.fromCodePoint(0xE04C)

    readonly property string volumeIconMuted:
        String.fromCodePoint(0xE04F)

    readonly property string volumeIconDisabled:
        String.fromCodePoint(0xE04F)
